    ...
    <div style={{ display: 'flex', minHeight: 'calc(100vh - 88px)', background: C.bg, fontFamily: 'Inter, sans-serif' }}>
      <style>{`
        ...
        @media (max-width: 900px) {
          .cordi-register-image { display: none !important; }
          .cordi-register-form { flex-basis: 100% !important; }
        }
      `}</style>
      ...
      <div className="cordi-register-form" style={{
        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <p style={{ marginTop: 28, fontSize: 14, color: C.muted, textAlign: 'center' }}>
            ...
            <Link to="/login" className="cordi-text-link">Inicia sesión</Link>
          </p>
        </div>
      </div>

      {/* ── PANEL DERECHO — IMAGEN EDITORIAL (desktop) ───────────────── */}
      <div className="cordi-register-image" style={{
        flexBasis: '46%', position: 'relative', overflow: 'hidden', order: 2,
      }}>
        <img
